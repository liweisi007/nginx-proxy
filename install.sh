...
RAW="https://raw.githubusercontent.com/liweisi007/nginx-proxy/main"
INSTALL="/usr/local/bin/nginx-proxy"
...
curl -fsSL "$RAW/nginx-proxy" -o "$INSTALL"
chmod +x "$INSTALL"
